...
// ─── Prices ───────────────────────────────────────────────────────────────
//
// ⚠ NOT USABLE YET — kept because it is written against the real spec and will
// work the moment the permission exists. Nothing calls it today.
//
...
//
// Blocked on authorisation: the endpoint sits behind the ErpRead policy, which
// per Scopes.md needs WK.BE.Erp / WK.BE.Erp.Read. Our client holds ERP.Base and
// ERP.Webshop, and requesting the extra scope was refused by Wolters Kluwer
// (invalid_scope, then "client application not found or authorized"). Enabling
// it is a request to WK against the Adsolut API Connectivity product — not
// something that can be fixed here.
//
// Until then product prices are maintained by hand in lib/catalog.js.
//
