...
// Shipping, as decimal strings. Orders at or above FREE_SHIPPING_FROM_EUR
// (products incl. VAT, before shipping) ship free; everything else pays
// SHIPPING_EUR. Change the numbers here and the whole site follows — the
// basket, the checkout page and the amount Mollie charges all read them.
const SHIPPING_EUR = "7.99";
const FREE_SHIPPING_FROM_EUR = "50.00";

module.exports = { PRODUCTS, SHIPPING_EUR, FREE_SHIPPING_FROM_EUR };
